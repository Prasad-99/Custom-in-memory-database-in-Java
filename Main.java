public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(executor.executeQuery(parser.parse("INSERT INTO users (name, email, age) VALUES (Dog, dog@example.com, 12)")));
        ...
        //Test Select
        System.out.println(executor.executeQuery(parser.parse("SELECT name FROM users where email = goldy@example.com")));
